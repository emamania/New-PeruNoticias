...
<div class="clear"></div>
<div class="content1-left <?php /*?><?php print $type; ?><?php */?>">
    <div class="">
    	<div class="image_content-left1">
        	<?php print $field_image; ?>
        </div>
        <!--<div class="meta-date">
    	<?php /*?><?php print $created; ?><?php */?> 
        </div>-->
        <div class="feature-text">
        	<div class="post-title"><h3 class="title"><?php print $title; ?></h3></div>
        	<div class="Cuerpoh31"><?php print $body; ?></div>
        </div>
    </div>
    <!--<div class="noticia-social">
    	<ul> <li class="social"><g:plusone size="medium" href="<!?php print $path; ?>"></g:plusone></li>
