...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>> <?php print $user_picture; ?> <?php print render($title_prefix); ?>
  ...
  <div class="submitted"> <?php print format_date($created, 'custom', 'd F Y'); ?> | <a href="<?php print ($teaser) ? $base_root . $node_url : ""; ?>#comments">
    <fb:comments-count href=<?php print $base_root . $node_url; ?>></fb:comments-count>
    comentarios</a> </div>
  <?php endif; ?>
  <!--Redes Sociales-->
  <div class="node-socials">
    <ul>
      ...
      <li class="node-social"> <a href="https://twitter.com/share" class="twitter-share-button" data-url="<?php print $base_root . $node_url; ?>" data-count="horizontal" data-via="PeruNoticiass" data-lang="es">Tweet</a> </li>
    </ul>
  </div>
  ...
  <div id="author">
    ...
    <div id="bio">
      ...
      <p>Estudiante de Comunicaci&oacute;n de la Universidad Nacional de San Antonio Abad del Cusco.
  ...
  <div id="comments">
    <h2 class="title"><?php print "¿Y tú que opinas?";//t('Comments'); ?></h2>
    <fb:comments href="<?php print $base_root . $node_url; ?>" num_posts="5" width="620"></fb:comments>
  </div>
</div>
<!-- /.node --> 
