...
<?php print $head; ?>
<?php if($is_front) : ?>
<meta property="og:url" content="http://perunoticias.net" />
<meta property="og:title" content="Noticias del Per&uacute; y del mundo"/>
<meta property="og:site_name" content="Per&uacute; Noticias" />
<meta property="og:image" content="http://media.perunoticias.net/images/logoperunoticias.jpg" />
<?php endif; ?>
<meta property="fb:app_id" content="141052366010573"/>
...
<script type="text/javascript" src="http://s7.addthis.com/js/250/addthis_widget.js#pubid=xa-4ed433613a80058b"></script>
</head>
<body class="<?php print $classes; ?>" <?php print $attributes;?>>
<div id="fb-root"></div>
<script type="text/javascript">
    window.fbAsyncInit = function() {
      FB.init({appId: '141052366010573', status: true, cookie: true,
               xfbml: true});
    };
    (function() {
...
<link href="https://plus.google.com/110529878965608924458" rel="publisher" /><script type="text/javascript">
