...
<div id="main">
  ...
  <div id="main-container">
    <div id="content" class="container_16">
      <div id="main-content" class="grid_10">
        <div id="main-content-inner">
          ...
          <div id="content-body">
            ...
            <?php
				...
				if ($page){
					print views_embed_view('slider', $display_id = 'block'); 
				}
			?>
            <?php else: ?>
            ...
            <?php endif; ?>
              ...
              <?php if ($is_front): ?>
              <h3 class="Name-Articulos">Articulos</h3>
              <div class="content-new">
              	<div>
                <div class="content-left"><?php print render($page['content_top_left']); ?></div>
              	<div class="content-right"><?php print render($page['content_top_right']); ?></div> 
               </div>
               </div>
              <?php endif; ?> 
              <?php if ($is_front): ?>
              <h3 class="Name-Articulos">Entretenimiento</h3>
              <div class="content-new">
              	<div>
                <div class="content1-left"><?php print render($page['content_center_left']); ?></div>
              	<div class="content1-right"><?php print render($page['content_center_right']); ?></div> 
               </div>
               </div>
              <?php endif; ?>  
  ...
  <!-- //#main-container -->
  <div id="footer">
    <div id="footer-inner" class="container_16 region region-footer">
      <div class="clear"></div>
