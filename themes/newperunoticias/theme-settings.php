 ...
 */
function perunoticias_form_system_theme_settings_alter(&$form, &$form_state)  {

  // Create the form using Forms API: http://api.drupal.org/api/7

  /* -- Delete this line if you want to use this setting
  $form['perunoticias_example'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('perunoticias sample setting'),
    '#default_value' => theme_get_setting('perunoticias_example'),
